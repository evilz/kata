...
namespace Minesweeper_csharp
{
    public class MinesweeperTests
    {
        ...
        public void Should_Parse_star_char_as_mine_cell()
        {
            ...
            Assert.That(firstField.GetSolution(), Is.StringContaining("*"));
        }
        ...
        public void Should_Parse_dot_char_as_clear_cell()
        {
            ...
            Assert.That(firstField.GetSolution(), Is.StringContaining("0"));
        }
        ...
        public void Should_Count_Neighbours_mine_cells(string input, string excpectedInOutput)
        {
            ...
            Assert.That(firstField.GetSolution(), Is.StringContaining(excpectedInOutput));
        }
...
0 0";
            ...
            Assert.That(minesweeper.GetSolution(), Is.StringStarting("Field #1:" + Environment.NewLine));
            Assert.That(minesweeper.GetSolution(), Is.StringContaining("Field #2:" + Environment.NewLine));
